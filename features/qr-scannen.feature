...
Funktionalität: Bogen per QR-Code einlesen
  ...
  Szenario: Ohne Kamera bleibt der Weg über ein Bild offen
    ...
    Und sehe ich den Hinweis "Keine Kamera verfügbar oder Zugriff verweigert."
    Und sehe ich den Hinweis "Stattdessen ein Foto oder einen Screenshot des QR-Codes einlesen."
    Wenn ich im Dialog "QR-Code scannen" auf "Abbrechen" klicke
    Dann sehe ich den Hinweis "Keine Kamera verfügbar oder Zugriff verweigert." nicht
