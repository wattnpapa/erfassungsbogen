...
- **`src/vokabulare/thw-funkrufname-ort.test.ts`** — Großstadtregelung der
  Funkrufnamen: OV-Erkennung über Kürzel und Name, führende OV-Kennzahl in
  Vorbelegung und Anzeige („Heros Berlin 06/22/51", „Heros Hamburg 7/22/51"),
  München/Bremen unverändert.
